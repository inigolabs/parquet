...
func (f *Int32OptionalField) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
...
func (f *Int64OptionalField) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
...
func (f *Float32Field) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
...
func (f *Float32OptionalField) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
...
func (f *Uint32Field) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
...
func (f *Uint64OptionalField) Read(ctx context.Context, r io.ReadSeeker, pg parquet.Page) error {
	rr, _, err := f.DoRead(ctx, r, pg)
	if err != nil {
		return err
	}
